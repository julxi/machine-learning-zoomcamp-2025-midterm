...
df_train, df_test = sk.model_selection.train_test_split(
...
pipeline = sk.pipeline.make_pipeline(
    sk.feature_extraction.DictVectorizer(sparse=False),
...
test_auc = sk.metrics.roc_auc_score(y_test, y_test_prob)
